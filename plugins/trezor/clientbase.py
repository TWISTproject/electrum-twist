...
from electrum_twist.keystore import bip39_normalize_passphrase
from electrum_twist.twist import EncodeBase58Check
...
class TrezorClientBase(GuiMixin, PrintError):
    ...
    #    return self.get_address('twist', self.expand_path(derivation))
