...
title = Electrum-twist

# (str) Package name
package.name = Electrum-twist

# (str) Package domain (needed for android/ios packaging)
package.domain = org.electrum_twist
...
presplash.filename = %(source.dir)s/icons/electrum-twist.png
...
android.manifest.intent_filters = gui/kivy/tools/twist_intent.xml
