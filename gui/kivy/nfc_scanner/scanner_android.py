...
from electrum_twist_gui.kivy.nfc_scanner import NFCBase
...
class ScannerAndroid(NFCBase):
    ...
    def create_AAR(self):
        ...
        '''
        return NdefRecord.createApplicationRecord(JString("org.electrum_twist.kivy"))

    def create_TNF_EXTERNAL(self, data):
        '''Create our actual payload record.
        '''
        if BUILDVERSION >= 14:
            domain = "org.electrum_twist"
            stype = "externalType"
            ...
            extRecord = NdefRecord(
                ...
                "org.electrum_twist:externalType",
                '',
                data)
        return extRecord
