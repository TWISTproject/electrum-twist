...
from electrum_twist_gui.kivy.uix.dialogs import EventsDialog
from electrum_twist_gui.kivy.i18n import _
from electrum_twist.base_wizard import BaseWizard
...
class RestoreSeedDialog(WizardDialog):
    ...
    def __init__(self, wizard, **kwargs):
        ...
        from electrum_twist.old_mnemonic import words as old_wordlist
