...
_ = lambda x:x
#from i18n import _
from electrum_twist.wallet import WalletStorage, Wallet
from electrum_twist.util import format_satoshis, set_verbosity, StoreDict
from electrum_twist.twist import is_valid, COIN, TYPE_ADDRESS
from electrum_twist.network import filter_protocol
...
class ElectrumGui:
    ...
    def __init__(self, config, daemon, plugins):
        ...
        if not storage.file_exists:
            print "Wallet not found. try 'electrum-twist create'"
            exit()
    ...
    def network_dialog(self):
        print("use 'electrum-twist setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-twist setconfig' to change your settings")
        return True
